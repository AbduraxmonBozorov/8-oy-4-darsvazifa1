...
const App = () => {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      <div className="steps mb-4 rounded-md shadow-md p-2">
            ...
            <Form className="form bg-white p-6 rounded-lg shadow space-y-4">
              <div className="form-control">
                ...
                {errors.businessAddress && touched.businessAddress ? (
                  <div className="text-red-500">{errors.businessAddress}</div>
                ) : null}
              </div>
              ...
              <div className="form-control">
                ...
                {errors.businessType && touched.businessType ? (
                  <div className="text-red-500">{errors.businessType}</div>
                ) : null}
              </div>
        ...
        >
          {() => (
            <Form className="form bg-white p-6 rounded-lg shadow space-y-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Use SMS</span>
                </label>
                <Field
                  name="sms"
                  type="text"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Use an authenticator app</span>
                </label>
                <Field
                  name="app"
                  type="text"
        ...
        >
          {() => (
            <Form className="form bg-white p-6 rounded-lg shadow space-y-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Business detailes</span>
                </label>
                <Field
                  name="sms"
                  type="file"
      ...
      {step > 1 && (
        <button onClick={prevStep} className="btn btn-outline w-full mt-4">
          Go Back
        </button>
      )}
    </div>
